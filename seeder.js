...
const recipes = [
...

    {
        ...
        timeNeeded: 60,
        ingredients: [
            {name: "Moong Lentils", quantity: "1 cup"},
            {name: "White Lentils", quantity: "2 cup"},
            {name: "Cumin Powder", quantity: "1 tbsp"},
            ...
            {name: "Coriander Leaves", quantity: "1/2 bunch"},
            {name: "Oil", quantity: ""},
...

    {
        ...
        timeNeeded: 75,
        ingredients: [
            {name: "Ground Beef", quantity: "1/2 kg"},
            {name: "Fats", quantity: "50 g"},
            {name: "Crushed Black Pepper", quantity: "1 tsp"},
            {name: "Red Chili Powder", quantity: "1 tbsp"},
            {name: "Green cardamom Powder", quantity: "1 tsp"},
            {name: "Cumin Powder", quantity: "1 tbsp"},
            {name: "Green Chilies", quantity: "4 finely chopped"},
            {name: "Fresh Coriander", quantity: "1 bunch chopped"},
            {name: "Ginger Garlic Paste", quantity: "2 tbsp"},
            {name: "Fried Onions Paste", quantity: "1/2 cup"},
            {name: "Roasted Chickpea Powder", quantity: "2-3 tbsp"},
            {name: "Salt", quantity: "To taste"},
            {name: "Oil", quantity: "As required"},
            {name: "Coal", quantity: "1 piece"},
        ],
        instructions: [
...

    {
        ...
        timeNeeded: "",
        ingredients: [
            {name: "Carrots", quantity: "1 + 1/2 kg grated"},
            {name: "Sugar", quantity: "1/2 kg"},
            {name: "Khoya", quantity: "1/2 kg"},
            {name: "Clarified butter", quantity: "1/2 cup"},
            {name: "Almonds, pistachios", quantity: "1/2 cup"},
            {name: "Cardamom ground", quantity: "1/2 tsp"},
        ],
        instructions: [
...

    {
        ...
        timeNeeded: 30,
        ingredients: [
            {name: "Flour", quantity: "1/2 kg"},
            {name: "Salt", quantity: "1 tsp"},
            {name: "Sugar", quantity: "2 tbsp"},
            {name: "Powder milk", quantity: "2 tbsp"},
            {name: "Baking powder", quantity: "1 tsp"},
            {name: "Master puff", quantity: "200 g"},
...

    {
        ...
        timeNeeded: 45,
        ingredients: [
            {name: "Mince Beef, Lamb, or Chicken", quantity: "500 g"},
            ...
            {name: "Garam Masala Powder", quantity: "1 tsp"},
            {name: "Salt", quantity: "To taste"},
            {name: "Frozen Peas", quantity: "100 g "},
        ],
        instructions: [
...

    {
        ...
        timeNeeded: 50,
        ingredients: [
            {name: "White flour", quantity: "500 g"},
            {name: "Yeast", quantity: "2 tsp"},
            {name: "Salt", quantity: "1/2 tsp"},
            {name: "Oil", quantity: "4 tbsp"},
            {name: "Hot water", quantity: "as required"},
            {name: "Garlic chopped", quantity: "2 tbsp"},
            {name: "Green Coriander", quantity: "2 tsp"},
