...
const translations = {
  en: {
    ...
    unitOptions: ["N/A", "tbsp", "tsp", "cup", "A pinch", "kg", "g", "liter", "bunch", "piece", "can", "packet", "A few drops", "A little bit", "To taste", "To fry", "As required", "For garnishing"],
    ...
    plzFillValidMail:"Please fill in a valid email address",
    plzEnterNewPw:"Please enter a new password",
    plzConfirmNewPw:"Please confirm new password",
    pwNotSame:"Passwords not same",
    rewritePw:"Please rewrite your password",
    emailInUse:"Email address is already in use",
    useAnotherMail:"Please use another email address",
    incorrectPw:"Incorrect password",
    reEnterPw:"Please re-enter your password",
  ...
  nl:{
    ...
    unitOptions:["n.v.t.", "eetlepel", "theelepel", "beker", "Een snuifje", "kg", "g", "liter", "bos", "stuk", "blik", "pakje", "Paar druppels", "Een beetje", "Naar smaak", "Om te bakken", "Naar behoefte", "Ter versiering"],
    ...
    plzFillValidMail:"Vul alstublieft een geldige e-mailadres in",
    plzEnterNewPw:"Vul alstublieft een nieuw wachtwoord in",
    plzConfirmNewPw:"Bevestig nieuw wachtwoord",
    pwNotSame:"Wachtwoorden komen niet overeen",
    rewritePw:"Vul je wachtwoord opnieuw in",
    emailInUse:"E-mail adres is al in gebruik",
    useAnotherMail:"Gebruik een ander e-mail adres",
    incorrectPw:"Fout wachtwoord",
    reEnterPw:"Vul je wachtwoord opnieuw in",
    firstName:"Voornaam",
    lastName:"Achternaam",
    email:"E-mail adres",
    changePw:"Wachtwoord wijzigen",
    currPw:"Huidig wachtwoord",
